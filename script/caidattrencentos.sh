...
# Create File cau hinh Virtual host apache

mkdir /etc/httpd/sites-available/
mkdir /etc/httpd/sites-enabled/

# Apache nhan cau hinh nhung virtual host trong sites-enabled
echo "
...
# tao mot lien ket symbolic link vao thu muc sites-enabled cua moi virtual host
